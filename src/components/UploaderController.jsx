...
const UploaderController = ({animateState}) => {
 ...
 className="uploader-controller flex flex-row items-end gap-[1.4vw] justify-between absolute bottom-0  p-[.9vw]  w-full h-fit">
                <div className="uploader-container  flex flex-col  gap-[.6vw]  w-fit h-fit">
                  <span className="uploader-img w-[3vw] overflow-hidden block h-[3vw]  rounded-full">
